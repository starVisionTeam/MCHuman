...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_ours.add_argument('--meshDirSearch', type=str, default="/mnt/DeepHuman")
        g_ours.add_argument('--trainingDataRatio', type=float, default="0.8")
        g_ours.add_argument('--datasetDir', type=str, default="/mnt/GeoRender")
        g_ours.add_argument('--totalNumFrame', type=int, default="108720", help="total data number: N*M'*4 = 6795*4*4 = 108720")
        g_ours.add_argument('--online_sampling', default=False, help='online query point sampling, or offline')
        ...
        g_ours.add_argument('--resultsDir', type=str,default="/media/sunjc0306/Elements SE/experimental results/IMGSMPLquery")
        g_ours.add_argument('--splitNum', type=int, default="5", help="for multi-process running")
        g_ours.add_argument('--splitIdx', type=int, default="4", help="{0, ..., splitNum-1}")
        ...
        g_ours.add_argument('--sampleType', type=str, default="occu_sigma3.5_pts5k")
        g_ours.add_argument('--keys_input', type=list, default=["img","mask","normal_F","normal_B","sample_data","deepVoxel"])#deepVoxel,
        ...
        g_ours.add_argument('--load_from_multi_GPU_shape', default=True, help='load weights to single-GPU model, from shape models trained with nn.DataParallel function')
        ...
        g_ours.add_argument('--deepVoxels_fusion', type=str, default='early', help='early | late')
        g_ours.add_argument('--deepVoxels_c_len', type=int, default=56, help='len of deepVoxel features when conducting fusion with 2D aligned features')
        ...
        g_ours.add_argument('--multiRanges_deepVoxels', default=True, help='use xyz-3-direction deepvoxels sampling')
        ...
        g_ours.add_argument('--deepVoxelsDir', type=str, default="/media/sunjc0306/Elements SE/experimental_results/IMGSMPL")#/mnt/dataset/GeoRender/HEI-Net_deep
        g_ours.add_argument('--normalDir', type=str, default="/mnt/dataset/GeoRender/normal")
        ...
        g_ours.add_argument('--openpose_dir', type=str, default="/home/sunjc0306/openpose-master", help='some models have to be run in train modes due to some hacky issues of BN layers')
        ...
        g_exp.add_argument('--name', type=str, default='HEINormal',
        ...
        g_train.add_argument('--num_threads', default=12, type=int, help='# sthreads for loading data')
        ...
        g_train.add_argument('--num_epoch', type=int, default=10, help='num epoch to train')
        ...
        parser.add_argument('--schedule', type=int, nargs='+', default=[3, 6],
        ...
        # path
        parser.add_argument('--checkpoints_path', type=str, default='/mnt/checkpoints_path/IMGSMPL', help='path to save checkpoints')
        parser.add_argument('--load_netV_checkpoint_path', type=str, default=None, help='path to save checkpoints')
        parser.add_argument('--load_netG_checkpoint_path', type=str, default='/mnt/checkpoints_path/IMGSMPL/IMGSMPL/netG_epoch_9_10871', help='path to save checkpoints')
        parser.add_argument('--load_netC_checkpoint_path', type=str, default=None, help='path to save checkpoints')
        parser.add_argument('--results_path', type=str, default='/mnt/training/TMM/results', help='path to save results ply')
