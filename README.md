- <p align="center">
  ...
  This repository contains a PyTorch implementation of "[Squeezing Multiple Cues from a Single Image for Clothed 3D Human Reconstruction](https://arxiv.org/abs/2007.03858)". Tested with PyTorch 1.4.0 on Ubuntu 18.04, CUDA 10.1. 
  ...
  **NOTE 2022/11/25**:  Our paper has been submitted to *IEEE Transaction on Multimedia*. Good luck. This page shows more results generated by our method from Internet images. 
  ...
  ![test images](.\Assets\pinterestShow.png)
